...
public class Seminar implements Enrollable {

    public String name;
    public int spots, credits, semester, year;
    public Professor professor;
    private ArrayList<Student> students;
    public final int minimumAttendanceRequirement = (int)(14 * 0.70);
    public ModelUpdateListener modelUpdateListener;
    public boolean hasEnrolledStudents;

    public Seminar(String name, int spots, int credits, int semester, int year, Professor professor) throws SQLException {
        this.name = name;
        this.spots = spots;
