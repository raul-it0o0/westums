...
public class Lecture implements Enrollable {
    ...
    public final double minimumAttendanceRequirement = (int)(14 * 0.50);
    public ModelUpdateListener modelUpdateListener;
    public boolean hasEnrolledStudents;

    public Lecture(String name, int spots, int credits, int semester, int year, Professor professor) throws SQLException {
        this.name = name;
        this.spots = spots;
